...
YOLO_MODEL_NAME = "yolo11n.pt"  # Nano model for compatibility (temp - will upgrade to yolo11l.pt later)
YOLO_MODEL_PATH = MODELS_DIR / YOLO_MODEL_NAME
YOLO_CONFIDENCE_THRESHOLD = 0.5
YOLO_IOU_THRESHOLD = 0.45
YOLO_DEVICE = "cuda"  # RTX 5090 GPU acceleration
YOLO_IMAGE_SIZE = 640  # Standard resolution for nano model
YOLO_USE_HALF_PRECISION = True  # FP16 for 2x speed boost
YOLO_BATCH_SIZE = 16  # Increased for smaller model
